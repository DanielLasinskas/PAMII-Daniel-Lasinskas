...
export default function WhatsApp() {
  const chats = [
    ...
    { id: 2, name: 'Cristiano Ronaldo🐐🤖', msg: '5 bolas de ouro e 2 de carne SIUUUU', time: '20:30', img: 'https://media.fstatic.com/OINkROEpIXatCIRBTL9uw98skWg=/full-fit-in/290x478/filters:format(webp)/media/artists/avatar/2020/04/cristiano-ronaldo_a336212.jpg' },
